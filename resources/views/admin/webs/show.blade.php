...
<div class="mx-auto px-6">
    <h2 class="text-3xl font-bold text-gray-800 mb-6">Detalles de la web</h2>
    @if (session('success'))
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="space-y-4">
            <div class="border-b border-gray-200 pb-4">
                ...
                <p class="text-gray-900">{{ $web->id }}</p>
            </div>
            ...
            <div class="border-b border-gray-200 pb-4">
                ...
                <p class="text-gray-900">{{ $web->created_at->format('d/m/Y H:i:s') }}</p>
            </div>

            <div class="border-b border-gray-200 pb-4">
                <h3 class="text-lg font-semibold text-gray-700">Última Actualización</h3>
                <p class="text-gray-900">{{ $web->updated_at->format('d/m/Y H:i:s') }}</p>
            </div>
        </div>
