                        ...
                        <td class="py-3 px-4 flex justify-end space-x-2">
                            ...
                            <div x-data="{ open: false, url: '' }">
                                ...
                                <button x-on:click="open = true; url = '{{ route('admin.webs.destroy', $web) }}'" 
                                        data-modal-trigger
                                        data-modal-target="modal-web-{{ $web->id }}"
                                        data-action-url="{{ route('admin.webs.destroy', $web) }}"
                            ...
                            <div id="modal-web-{{ $web->id }}" class="modal fixed inset-0 bg-black bg-opacity-50 z-50 modal-overlay" style="display: none;">
                                <div class="fixed inset-0 flex items-center justify-center z-50">
                                    <div class="bg-white rounded-lg shadow-lg p-6 w-11/12 max-w-md">
                                        ...
                                        <div class="flex justify-end space-x-4">
                                            ...
                                            <form action="{{ route('admin.webs.destroy', $web) }}" method="POST" class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" 
                                                        class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg shadow-md transition">
