    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div class="border-b border-gray-200 pb-4">
                    <label for="password" class="text-lg font-semibold text-gray-700">Contraseña (dejar en blanco para no cambiar)</label>
                ...
                <div class="border-b border-gray-200 pb-4">
                    <label for="password_confirmation" class="text-lg font-semibold text-gray-700">Confirmar Contraseña</label>
